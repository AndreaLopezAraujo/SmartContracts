...
# Join peer0.exportingentityorg.impreAndes.com to 'tradechannel'
./trade.sh joinneworg -c tradechannel

# Join peer0.exportingentityorg.impreAndes.com to 'shippingchannel'
./trade.sh joinneworg -c shippingchannel

# Set peer0.exportingentityorg.impreAndes.com as anchor peer for exportingentityorg in 'tradechannel'
./trade.sh updateneworganchorpeer -c tradechannel

# Set peer0.exportingentityorg.impreAndes.com as anchor peer for exportingentityorg in 'shippingchannel'
